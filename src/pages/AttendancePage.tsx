  ...
  const loadData = useCallback(async () => {
    ...
    const [pRes, aRes] = await Promise.all([
      supabase
        ...
        .select("id, child_first_name, child_last_name, age, date_of_birth, kit_size, kit_given, medical_condition, medical_notes, photo_permission, payment_status, amount_paid, amount_owed, total_amount, sibling_discount, refund_amount, payment_type, staff_notes, parent_name, parent_email, parent_phone, emergency_contact, alternate_phone, booking_date")
      ...
      {camp && (
        <>
          ...
          <div className="flex flex-wrap items-center gap-2 px-1">
            ...
            <Button variant="outline" size="sm" onClick={() => setBulkPaidOpen(true)}>
